...
const HELP = {
  ...
  comber_noil: "Comber noil % removed for this cotton variety (optional)",
...
function blankCotton() {
  return {
    name: "", cost_per_bale: "", bale_weight: "", trash_pct: "", lint_loss_pct: "",
    comber_noil_pct: "", min_bales: "", max_bales: "",
  ...
  async function handleSolve() {
    ...
    const body = {
      ...
      cottons: cottons.map((c, i) => ({
        ...
        lint_loss_pct: toNum(c.lint_loss_pct) ?? 0,
        comber_noil_pct: toNum(c.comber_noil_pct) ?? 0,
          ...
          <table border="1" cellPadding="6" style={{ borderCollapse: "collapse", width: "100%" }}>
            ...
            <tbody>
              ...
              <tr>
                ...
                {cottons.map((c, i) => (
                  <td key={i}><input type="number" value={c.lint_loss_pct} onChange={e => updateCotton(i, "lint_loss_pct", e.target.value)} /></td>
                ))}
                <td></td>
              </tr>
              <tr>
                ...
                {cottons.map((c, i) => (
                  <td key={i}><input type="number" value={c.comber_noil_pct} onChange={e => updateCotton(i, "comber_noil_pct", e.target.value)} /></td>
                ))}
                <td></td>
              </tr>
              <tr>
